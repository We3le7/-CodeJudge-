package com.wes.wojbackendquestionservice.controller;

import cn.hutool.json.JSONUtil;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;

import com.wes.wojbackendcommon.annotation.AuthCheck;
import com.wes.wojbackendcommon.common.BaseResponse;
import com.wes.wojbackendcommon.common.DeleteRequest;
import com.wes.wojbackendcommon.common.ErrorCode;
import com.wes.wojbackendcommon.common.ResultUtils;
import com.wes.wojbackendcommon.constant.UserConstant;
import com.wes.wojbackendcommon.exception.BusinessException;
import com.wes.wojbackendcommon.exception.ThrowUtils;
import com.wes.wojbackendmodel.dto.question.*;
...
import com.wes.wojbackendmodel.dto.user.vo.QuestionVO;
...
public class QuestionController {
    ...
    public BaseResponse<Question> getQuestionById(long id, HttpServletRequest request) {
        ...
        User loginUser = userFeignService.getLoginUser(request);
        if(!question.getUserId().equals(loginUser.getId()) && !userFeignService.isAdmin(loginUser)){
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR);
        }
     ...
     * @return
     */
    @GetMapping("/get/question_submit/vo")
    ...
    /**
     * 分页获取题目提交列表，除管理员外普通用户只能看到非答案等公开信息
     *
