...
import com.wes.wojbackendmodel.dto.question.QuestionQueryRequest;
...
import com.wes.wojbackendquestionservice.mapper.QuestionMapper;
...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question>
    ...
    public QuestionVO getQuestionVO(Question question, HttpServletRequest request) {
        ...
        if (userId != null && userId > 0) {
            user = userFeignService.getById(userId);
        }
        UserVO userVO = userFeignService.getUserVO(user);
    ...
    public Page<QuestionVO> getQuestionVOPage(Page<Question> questionPage, HttpServletRequest request) {
        ...
        Map<Long, List<User>> userIdUserListMap = userFeignService.listByIds(userIdSet).stream()
        ...
        List<QuestionVO> questionVOList = questionList.stream().map(question -> {
            ...
            questionVO.setUserVO(userFeignService.getUserVO(user));
            return questionVO;
